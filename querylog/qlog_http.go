...
func (l *queryLog) initWeb() {
	...
	l.conf.HTTPRegister("POST", "/control/querylog", func(w http.ResponseWriter, r *http.Request) {
		l.handleQueryLog(w, r)
	})
	l.conf.HTTPRegister("GET", "/control/querylog_info", func(w http.ResponseWriter, r *http.Request) {
		l.handleQueryLogInfo(w, r)
	})
	l.conf.HTTPRegister("POST", "/control/querylog_clear", func(w http.ResponseWriter, r *http.Request) {
		l.handleQueryLogClear(w, r)
	})
	l.conf.HTTPRegister("POST", "/control/querylog_config", func(w http.ResponseWriter, r *http.Request) {
		l.handleQueryLogConfig(w, r)
	})
}
